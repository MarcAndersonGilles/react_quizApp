...
function Home() {
  const questions = [
    ...
    {
			questionText: 'Quel est le premier but de Natsu Dragnir dans la série Fairy Tail',
      		imageUrl: natsu,
			answerOptions: [
				{ answerText: 'Retrouver son père', isCorrect: true },
				{ answerText: 'Tuer un dragon', isCorrect: false },
				{ answerText: 'Rejoindre la guilde de Fairy Tail ', isCorrect: false },
				{ answerText: 'Se faire des amis', isCorrect: false },
			],
		},
    {
			questionText: 'Quel est le but premier but de Tanjiro Kamado dans la série Demon Slayer',
      		imageUrl: tanjiro,
			answerOptions: [
            ...
            <div className='answer-section'>
              {questions[currentQuestion].answerOptions.map((answerOption, index) => (
                <button
                  ...
                  className={answerOption.isCorrect ? 'correct-answer' : 'wrong-answer'}
                >
